...
function createViewStackSplineMultipleAreaXFunction(container, width, height) {
	...
	var area1 = new JenScript.Area({
			...
			areaBase : 0,
			shader : {percents : [ '0%', '100%' ],opacity:[0.5,0.5], colors : ['orange','orange']}
			});
	...
	var area2 = new JenScript.Area({
		...
		areaBase : 0,
		shader : {percents : [ '0%', '100%' ],opacity:[0.5,0.5], colors : ['blue','blue']}
	});
	...
	var area3 = new JenScript.Area({
		...
		areaBase : 0,
		shader : {percents : [ '0%', '100%' ],opacity:[0.5,0.5], colors : ['red','red']}
	});
