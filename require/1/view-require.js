...
createView = function(j,container,w,h){
		...
		j.view({
			...
			minY : -1000,
			maxY : 1000
		}).pie({radius : 120,startAngleDegree : 45}).slice({
			name : "s1",
			value : 45,
			...
			text : "Chrome",
			fillColor:'black',
			outlineColor : JenScript.RosePalette.AEGEANBLUE,
			cornerRadius : 8,
			outlineWidth : 2,
			textColor :JenScript.Color.lighten(JenScript.RosePalette.AEGEANBLUE,30),
		}).slice({
			name : "s5",
			value : 5,
